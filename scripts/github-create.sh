...
echo "Will create a new *$PRIVACYWORD* repo named alpine-base-edge"
echo "on github.com in:"
echo "    user account: admindaspanel"
echo "    organization: daspanel"
echo "with this description:"
echo Alpine Linux Edge contains all the boilerplate you need to create an Docker container using Alpine Linux Edge latest version.
echo ""
...
curl -u admindaspanel https://api.github.com/orgs/daspanel/repos -d \
    "{\"name\": \"alpine-base-edge\", \"description\": \"Alpine Linux Edge contains all the boilerplate you need to create an Docker container using Alpine Linux Edge latest version.\", \"private\": $PRIVATE_TF}"
